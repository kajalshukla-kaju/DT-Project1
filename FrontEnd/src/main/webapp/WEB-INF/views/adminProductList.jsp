...
<a class="btn btn-info" role="button" href="${contextRoot}/admin/updateProduct?productid=${p.productid}">Edit</a>
<a class="btn btn-danger" role="button" href="${contextRoot}/admin/deleteProduct?productid=${p.productid}">Delete</a>
</td>
</tr>
